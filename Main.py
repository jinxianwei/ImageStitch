...
def stitchWithFeature():
    ...
    Stitcher.offsetCaculate = "ransac"            # "mode" or "ransac"
    ...
    # Stitcher.direction = 2;  Stitcher.directIncre = 0;
    # projectAddress = "demoImages\\chip"
    # outputAddress = "result\\chip" + str.capitalize(Stitcher.fuseMethod) + "\\"
    # # stitcher.imageSetStitchWithMutiple(projectAddress, outputAddress, 1, stitcher.calculateOffsetForFeatureSearchIncre,
    # #                         startNum=1, fileExtension="tif", outputfileExtension="tif")
    # stitcher.imageSetStitchWithMutiple(projectAddress, outputAddress, 1, stitcher.calculateOffsetForFeatureSearchIncre,
    #                         startNum=1, fileExtension="tif", outputfileExtension="tif")
    
    Stitcher.direction = 2;  Stitcher.directIncre = 0;
    projectAddress = "demoImages\\chip2"
    outputAddress = "result\\chip2" + str.capitalize(Stitcher.fuseMethod) + "\\"
    stitcher.imageSetStitchWithMutiple(projectAddress, outputAddress, 1, stitcher.calculateOffsetForPhaseCorrleate,
                            startNum=1, fileExtension="tif", outputfileExtension="tif")
